    ...
    return(
        <section className='lg:px-24'>
            ...
            <div className='lg:flex lg:gap-6'>
                <div className='lg:rounded-lg font-montserrat lg:mt-28 p-6 mb-6 md:h-[500px] bg-[#4ABE9917]'>
                ...
                <div className='lg:rounded-lg font-montserrat lg:mt-16 p-6 mb-6 md:h-[500px] bg-[#4ABE9917]'>
                ...
                <div className='lg:rounded-lg font-montserrat p-6 mb-6 lg:pb-6 md:h-[500px] bg-[#4ABE9917]'>
